...
const Modern = () => {
  return (
      ...
      <div className=''>
      <div className='text-4xl text-[#E98074] mt-16 mb-10'>
      اقتصاد برای غیر اقتصاددانان        </div>
    ...
    <div className="grid grid-cols-3 gap-4">
      ...
      <div className="space-y-8 relative h-96">
    ...
    <div className='text-[#E98074] mt-5'><strong> لورم ایپسوم متن ساختگی با تولید سادگی</strong></div>
